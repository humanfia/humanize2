...
:class:`~amflows.coganchor.proto.Kind.CHUNK` frames as output arrives and closes the exchange
with a single :class:`~amflows.coganchor.proto.Kind.RSP`, so the server's reader loop is never
...
from amflows.coganchor.proto import CHUNK_SIZE, Channel, Frame, Stream
