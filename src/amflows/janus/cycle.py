...
it went. Enough to gather a trace of the run afterwards out of the ids alone, and enough for
janus to find the sessions a run left behind.
...
def _now() -> str:
    """This moment, as every file amflows writes spells one."""
    return (
