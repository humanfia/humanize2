...
Nothing here reaches a CLI. Making a provider is :mod:`humanize.providers.login`, running a
turn under one is :mod:`humanize.providers.redirect`, and this is only the answer to "which
...
from humanize import backends, home
...
class Provider:
    ...
    Attributes:
      ...
      way: The way it was made by, as :class:`humanize.backends.Way` names them.
