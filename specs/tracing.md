...
Gathers the sessions asked for and returns the trace as a document. `hmz.sdk.Epics.trace` and
`hmz.sdk.Epics.traced` are shells around it, and what the interface offers on a run is reached
through them.
