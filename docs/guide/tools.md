...
- [Hooks](/guide/hooks) — the other direction: a word in at a moment of the turn
- [Calling flows](/guide/calling-flows) — a flow that calls another by name
- [The mission board](/guide/board) — the other thing that does not stop a turn
