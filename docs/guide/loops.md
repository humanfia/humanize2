...
is the most important choice a flow makes. See [Concepts › Session](/guide/concepts#session).
...
Both loops say they [can be picked up](/guide/resuming). They keep which round they are on, so
...
[two agents taking turns](/tutorials/take-home) it is the shape of the run.
...
past a stop and never end. See [Stopping](/guide/stopping).
...
- [Concepts › Session](/guide/concepts#session)
- [Stopping](/guide/stopping)
- [Cost and rate](/guide/tally)
- [Efforts](/guide/efforts)
- [Beat a benchmark](/tutorials/take-home)
