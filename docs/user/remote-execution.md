...
Linux on x86-64 **here**. A POSIX system with a recent `python3` **there** — Linux or macOS,
on any architecture. No root, no compiler, no kernel module, nothing installed on the far end.
