...
Anything tighter is a choice. Make it deliberately. See [Security](/user/security).
...
A [hook](/weaver/hooks) hung on `PERMISSION_REQUEST` can refuse something and have the agent hear
